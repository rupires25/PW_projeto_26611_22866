...
//Limpa a informação que a tabela contêm
    ...
    function adicionarInformacao() {
        // Obter os valores dos inputs da página tabelaClientes.html
        const nome = document.getElementById('nome').value;
        const marca = document.getElementById('marca').value;
        const problemas = document.getElementById('problemas').value;
        const data = document.getElementById('data').value;
        ...
        // Criar uma nova linha na tabela da página listaClientes.html
        const tbody = document.getElementById('tbody');
        ...
        // Retornar à página listaClientes.html após adicionar a informação à tabela
